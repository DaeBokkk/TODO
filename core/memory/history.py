...
class HistoryManager:
    def __init__(self):
        ...
        # 2. [추가] 추출된 정보 상태 저장소 (슬롯 필링용)
        # 구조: { "session_id": { "location": "강남구", "property_type": "아파트", ... } }
    ...
    def update_state(self, session_id: str, new_fields: dict) -> dict:
        """
        새로 추출된 정보를 기존 정보와 합칩니다 (Merge).
        새로운 값이 Null이 아니면 기존 값을 덮어씁니다.
        """
