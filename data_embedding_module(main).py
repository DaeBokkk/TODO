...
from langchain_openai import OpenAIEmbeddings # <--- [수정됨] OpenAI 전용 모듈로 변경
...
# (1) 임베딩 모델 설정 (OpenAI로 변경됨)
MODEL_ID = "text-embedding-3-small"
OPENAI_API_KEY = "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" # API 키 입력
